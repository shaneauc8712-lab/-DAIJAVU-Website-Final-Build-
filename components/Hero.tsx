              ...
              <div className="w-full h-full bg-gradient-to-tr from-background-mid to-black p-1 flex flex-col items-center justify-center relative overflow-hidden">
                 ...
                 <div className="relative z-10 flex flex-col items-center">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center">
                       <div className="text-[10px] tracking-[0.3em] uppercase text-primary-cyan font-bold mb-2">Diagnostic Active</div>
                       <div className="text-2xl font-black text-white tracking-tighter">TAISON v2.5</div>
                    </div>
                 </div>

                 {/* Floating Data Points */}
                 <div className="absolute bottom-8 left-8 right-8 flex justify-between">
                    <div className="text-[8px] font-mono text-border">SYS_UPTIME: 99.99%</div>
                    <div className="text-[8px] font-mono text-border">LATENCY: 0.04ms</div>
                 </div>
              </div>
            </div>
          </div>
